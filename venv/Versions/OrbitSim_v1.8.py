...
def radiation(a):
    ...
    for i in range(a):
        ...
        plt.polar(temp_sol_2.y[2], temp_sol_2.y[0])
...
plt.figure()
plt.plot(sol.t[10: - 4], (2*M*(I_ddot[1][0][10:])))
plt.plot(sol.t[10: - 4], (2*M*(I_ddot[0][1][10:])))
plt.plot(sol.t[10: - 4], (2*M*(I_ddot[1][1][10:])))
plt.plot(sol.t[10: - 4], (2*M*(I_ddot[0][0][10:])))
plt.xlim(1200, 1700)
